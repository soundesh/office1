...
const Forgot = () => {
  ...
  return (
    <div className="lg:relative bg-slate-200 flex flex-column space-y-5 datalist  bg-white">
      ...
      <div className="flex flex-column items-center  justify-center rounded-3xl max-w-[20%] lg:min-w-[35%]  bg-white lg:min-h-[60vh] lg:hover:shadow-md lg:shadow-2xl lg:absolute top-0 md:top-20 lg:mt-20 lg:mr-32  right-0">
